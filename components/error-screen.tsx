...
const styles = StyleSheet.create({
    container: { flex: 1, justifyContent: "center", alignItems: "center", padding: 32, backgroundColor: "#F0F4F8" },
    ...
    button: { backgroundColor: "#0D9488", paddingHorizontal: 24, paddingVertical: 10, borderRadius: 8 },
